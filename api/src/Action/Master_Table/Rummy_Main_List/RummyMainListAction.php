...
namespace App\Action\Master_Table\Rummy_Main_List;

//Service
use App\Domain\Master_Table\Rummy_Main_List\Service\RummyMaxSeatsService;
...
final class RummyMainListAction
{
