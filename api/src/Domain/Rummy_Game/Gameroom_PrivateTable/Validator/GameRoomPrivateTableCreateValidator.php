...
namespace App\Domain\Rummy_Game\Gameroom_PrivateTable\Validator;
...
final class GameRoomPrivateTableCreateValidator
{
    private GameRoomPrivateTableRepository $repository;

    public function __construct(GameRoomPrivateTableRepository $repository)
    {
